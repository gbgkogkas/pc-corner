    ...
    <body>
        <header>
            <div class="row header-row">
                ...
                <ul class="menu-line">
                    <li>
                        <a class="button tab-trigger" data-target="products" href="#">Products</a>
                    </li>
                    <li>
                        <a class="button tab-trigger" data-target="cart" href="#">Cart</a>
                    </li>
                </ul>
            </div>
        </header>
        <main>
            ...
            <section id="cart" class="hide tab">
                            ...
                            <%
                                if (inCart.size() > 0) {
                                    for (int i = 0; i < inCart.size(); i++) {
                                        ...
                                        out.println(MessageFormat.format("<tr id=\"product_{4}\" data-product-id=\"{4}\"><td>{0}</td><td><span class=\"weight_display\">{1}</span></td><td><input class=\"quantity\" type=\"number\" value=\"{2}\"/></td><td><span class=\"price_display\">{3}</span> &euro;</td></tr>",
